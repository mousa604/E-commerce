...
//
//     final searchVm = searchVmFromJson(jsonString);

import 'dart:convert';

SearchVm searchVmFromJson(String str) => SearchVm.fromJson(json.decode(str));

String searchVmToJson(SearchVm data) => json.encode(data.toJson());
...
class SearchVm {
  ...
  factory SearchVm.fromJson(Map<String, dynamic> json) => SearchVm(
